...
AS
   SELECT S.StudentID,S.FirstName + ' ' + S.LastName AS 'FullName',R.CourseId,R.Mark,C.CourseName
   FROM Student S 
   LEFT OUTER JOIN Registration R ON R.StudentID = S.StudentID
   LEFT OUTER JOIN Course C ON C.CourseId = R.CourseId
GO
...
SELECT StudentID,FullName,CourseName,Mark FROM StudentGrades WHERE StudentID = 199899200
